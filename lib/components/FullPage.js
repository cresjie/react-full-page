  ...
  function FullPage(props) {
    ...
    _this.onTouchMove = function (evt) {
      ...
      if (!childHasVerticalScroll) {
        ...
        if (!window._isScrollPending && !_this._isScrolledAlready) {
    ...
    _this.onScroll = function (evt) {
      ...
      evt.preventDefault();
      console.log(window._isScrollPending);
    ...
    _this.scrollToSlide = function (slide) {
      if (!window._isScrollPending && slide >= 0 && slide < _this.state.slidesCount) {
