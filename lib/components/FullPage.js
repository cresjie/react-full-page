...
var FullPage = /*#__PURE__*/function (_React$Component) {
  ...
  function FullPage(props) {
    ...
    _this.onScroll = function (evt) {
      ...
      evt.preventDefault();
      console.log(_this._isScrollPending, _this._isScrollToSlidePending);

      if (_this._isScrollPending || _this._isScrollToSlidePending) {
        return;
      }

      _this._isScrollToSlidePending = true;
      var scrollDown = (evt.wheelDelta || -evt.deltaY || -evt.detail) < 0;
      var activeSlide = _this.state.activeSlide;
      var isTrackPadScrolling = evt.deltaY > 0 && evt.deltaY < 30 || evt.deltaY > -30 && evt.deltaY < 0;
      ...
      _this._isScrollToSlidePending = false;
    };
